   ...
   public function test_users_can_authenticate_with_valid_credentials(): void
{
    ...
    $response->assertRedirect('/dashboard'); // Pastikan path redirect benar
}
    /**
    ...
    public function test_logout_invalidates_session(): void
{
    ...
    // Pastikan user login dulu, lalu POST ke logout
    $response = $this->actingAs($user)->post('/logout');

    $this->assertGuest();
    $response->assertRedirect('/'); // Biasanya Breeze redirect ke '/' setelah logout
}
    /**
