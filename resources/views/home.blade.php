        ...
        <div class="row mb-5">
            <div class="col-12">
                <div class="card border-0 bg-primary text-white shadow-lg"
                    style="background: linear-gradient(135deg, #0d6efd 0%, #0b5ed7 50%, #0a58ca 100%);">
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="d-flex justify-content-center gap-3 flex-wrap">
                            ...
                            <a href="{{ route('security-testing.index') }}" class="btn btn-outline-light btn-lg px-4" <i
                                class="bi bi-shield-shaded me-2"></i> Security Testing
                            </a>
                        </div>
                    </div>
                </div>
